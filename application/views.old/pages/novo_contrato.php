<form method="post" id="formulario" action="<?=base_url("financeiro/cadastrarcontrato");?>">
		...
		document.getElementById('procuraClientes').addEventListener("click", function(){
		 ...
		 function createTable(result){
		   ...
		   for(index in result){
			  ...
			  tr += "<td>"+ cpf +"</td>";
			  tr += "<td>"+ orgao +"</td>";
			  tr += "<td><button type='button' class='btn btn-success btn-sm' onclick='escolheCliente("+result[index].id+")'>Escolher</button></td>";
			  tr += "</tr>";
