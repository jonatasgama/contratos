<form method="post" class="aparicao" action="<?=base_url("financeiro/editarcontrato");?>">
...
<legend>Contrato</legend>
	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
		<?php 
			$cliArray = explode(" ",$cliente['0']->cliente);
			$cli = $cliArray['0'];
			$idBusca = $cliente['0']->id;
		?>
		<li class="breadcrumb-item"><a href="<?=base_url("financeiro/buscarCliente/$cli");?>">Listagem de clientes</a></li>
		<li class="breadcrumb-item"><a href="<?=base_url("financeiro/visualizaContratos/$idBusca");?>">Contratos</a> <?=$cliente['0']->cliente;?></li>
		<li class="breadcrumb-item active" aria-current="page">Editar contrato <?=$contrato['0']->numero_contrato;?></li>
	  </ol>
	</nav>	
...
<?=$this->session->set_flashdata('redirect', "contrato_visualizado");?>
