...
class Financeiro extends CI_Controller {
	...
	public function dashboard(){
		$vendas = $this->financeiro_model->vendasMes()->result();
		$data = [];
		...
		$dados['vendasMes'] = json_encode($data);		
		$dados['contratosAndamento'] = $this->financeiro_model->contratosAndamento()->result();
		$dados['contratosPagos'] = $this->financeiro_model->contratosPagos()->result();
		$dados['contratosFinalizados'] = $this->financeiro_model->contratosFinalizados()->result();
...
//#################################				CONTRATO			####################################################	
	...
	public function novoContrato(){
		...
		$dados['consultores'] = $this->financeiro_model->listarConsultores()->result();
		$this->load->view('template/header');
	...
	public function cadastrarContrato(){
		if($this->input->post('cliente_existente') == ""){
			...
			$tbl_contrato['id_consultor'] = $this->input->post('consultor');
	...
	public function listaContratosFinalizados(){
		$dados['contratos'] = $this->financeiro_model->listaContratosFinalizados()->result();
		$this->load->view('template/header');
		$this->load->view('pages/lista_contratos_finalizados', $dados);
		$this->load->view('template/footer');
	}
	
	public function listaContratosPagos(){
		$dados['contratos'] = $this->financeiro_model->listaContratosPagos()->result();
		$this->load->view('template/header');
		$this->load->view('pages/lista_contratos_pagos', $dados);
		$this->load->view('template/footer');
	}

	public function listaContratosEmAndamento(){
		$dados['contratos'] = $this->financeiro_model->listaContratosEmAndamento()->result();
		$this->load->view('template/header');
		$this->load->view('pages/lista_contratos_andamento', $dados);
		$this->load->view('template/footer');
	}	
